...
import { GenerateTokenDialogComponent } from '../protected/user/generate-token-dialog/generate-token-dialog.component';
...
import { ConfigureThemeDialog } from '../protected/dashboard/components/configure-theme/configure-theme-dialog.component';
