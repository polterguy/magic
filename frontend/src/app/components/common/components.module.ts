...
import { GenerateTokenDialogComponent } from '../protected/pages/user/generate-token-dialog/generate-token-dialog.component';
...
import { ConfigureThemeDialog } from '../protected/pages/dashboard/components/configure-theme/configure-theme-dialog.component';
