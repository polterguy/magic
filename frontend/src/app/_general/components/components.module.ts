...
import { GenerateTokenDialogComponent } from '../../components/_protected/pages/user/generate-token-dialog/generate-token-dialog.component';
...
import { ConfigureThemeDialog } from '../../components/_protected/pages/dashboard/components/configure-theme/configure-theme-dialog.component';
