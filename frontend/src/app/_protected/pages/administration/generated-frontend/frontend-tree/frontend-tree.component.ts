...
import { FlatNode } from 'src/app/components/tools/ide/models/flat-node.model';
import { TreeNode } from 'src/app/components/tools/ide/models/tree-node.model';
...
@Component({
  selector: 'app-frontend-tree',
  templateUrl: './frontend-tree.component.html',
  styleUrls: ['./frontend-tree.component.scss']
})
export class FrontendTreeComponent implements OnInit, OnDestroy {
  ...
  */
   ...
   */
  activeFolder: string = '/etc/frontend/src/';

  /**
  * Current folder we're viewing contens of.
  */
  currentFolder = '/etc/frontend/src/';
