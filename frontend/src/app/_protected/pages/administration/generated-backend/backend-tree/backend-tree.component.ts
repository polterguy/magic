...
import { FlatNode } from '../../../tools/hyper-ide/_models/flat-node.model';
...
import { IncompatibleFileDialogComponent } from '../../generated-frontend/components/incompatible-file-dialog/incompatible-file-dialog.component';
import { NewFileFolderDialogComponent } from '../../generated-frontend/components/new-file-folder-dialog/new-file-folder-dialog.component';

@Component({
  selector: 'app-backend-tree',
  templateUrl: './backend-tree.component.html',
  styleUrls: ['./backend-tree.component.scss']
})
export class BackendTreeComponent implements OnInit, OnDestroy {
