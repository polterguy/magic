...
export class Backend {
  ...
  createAccessRights() {
    this._access = {
      ...
      auth: {
        view_users: this.canInvoke('magic/system/magic/users', 'get') && this.canInvoke('magic/system/magic/users-count', 'get') && this.canInvoke('magic/system/magic/users_roles', 'get') && this.canInvoke('magic/system/magic/users_roles-count', 'get'),
        view_roles: this.canInvoke('magic/system/magic/roles', 'get'),
        create_user: this.canInvoke('magic/system/magic/users', 'post'),
        create_role: this.canInvoke('magic/system/magic/roles', 'post'),
        delete_user: this.canInvoke('magic/system/magic/users', 'delete'),
        delete_role: this.canInvoke('magic/system/magic/roles', 'delete'),
        update_user: this.canInvoke('magic/system/magic/users', 'put'),
        update_role: this.canInvoke('magic/system/magic/roles', 'put'),
        create_user_role: this.canInvoke('magic/system/magic/users_roles', 'post'),
        delete_user_role: this.canInvoke('magic/system/magic/users_roles', 'delete'),
        update_user_role: this.canInvoke('magic/system/magic/users_roles', 'put'),
      ...
      crypto: {
        crypto_keys: this.canInvoke('magic/system/magic/crypto_keys', 'get'),
        ...
        crypto_invocations: this.canInvoke('magic/system/magic/crypto_invocations', 'get'),
        delete_public_key: this.canInvoke('magic/system/magic/crypto_keys', 'delete'),
        save_public_key: this.canInvoke('magic/system/magic/crypto_keys', 'put'),
      },
      cache: {
