...
- `moduleUrl` is the mandatory relative URL of the generated endpoint, without verb and extension. Its full URL becomes `moduleName/moduleUrl`.
...
- `auth` is an optional comma separated list of roles allowed to invoke the endpoint. Omitting it creates an endpoint anyone can invoke.
